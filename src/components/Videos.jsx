    ...
    <Stack direction={['column','row']} h={'100vh'}>
        <VStack w={'full'}>
            ...
            <VStack alignItems={'flex-start'} p={8} w={'full'} overflowY={'auto'}>
                ...
                <Heading>Sampale Video 1</Heading>
                <Text>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Reprehenderit voluptate omnis hic nemo provident impedit quis corrupti ducimus. Quis suscipit illo ut aspernatur corporis vel numquam qui culpa? Consequatur, incidunt.
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Magni quae saepe error sed itaque, veritatis est repellendus voluptas debitis eos autem voluptate ducimus perferendis animi cumque, esse sit. Sed, impedit.
                </Text>
            </VStack>
        </VStack>        
